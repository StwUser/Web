...
function openContainer(){
	...
	//Rotate Buttons
	document.getElementById("right_btn").classList.add('rotated90deg');
	document.getElementById("left_btn").classList.add('rotated90deg');
	...
	curtain.style.background = "1px solid red";
